...
<nav class="nav flex-column col-2 bg-dark vh-100 sticky-top">
  ...
  <a class="nav-link text-white" href="landing-stations.jsp">Landing Stations</a>
  <a class="nav-link text-white" href="segmentos.jsp">Segmentos</a>
  <a class="nav-link text-white" href="reportes.jsp">Reportes</a>
